\hypertarget{class_t_g_l_annotation}{
\section{TGLAnnotation Class Reference}
\label{class_t_g_l_annotation}\index{TGLAnnotation@{TGLAnnotation}}
}
...
{\ttfamily \#include $<$ROOTClasses.h$>$}Inheritance diagram for TGLAnnotation::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2cm]{class_t_g_l_annotation}
\end{center}
\end{figure}
...
Definition at line 26 of file ROOTClasses.h.
