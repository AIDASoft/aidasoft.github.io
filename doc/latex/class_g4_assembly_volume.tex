\hypertarget{class_g4_assembly_volume}{
\section{G4AssemblyVolume Class Reference}
\label{class_g4_assembly_volume}\index{G4AssemblyVolume@{G4AssemblyVolume}}
}
...
{\ttfamily \#include $<$Geant4Classes.h$>$}Inheritance diagram for G4AssemblyVolume::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2cm]{class_g4_assembly_volume}
\end{center}
\end{figure}
...
Definition at line 4 of file Geant4Classes.h.
