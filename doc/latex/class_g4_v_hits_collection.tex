\hypertarget{class_g4_v_hits_collection}{
\section{G4VHitsCollection Class Reference}
\label{class_g4_v_hits_collection}\index{G4VHitsCollection@{G4VHitsCollection}}
}
...
{\ttfamily \#include $<$Geant4Classes.h$>$}Inheritance diagram for G4VHitsCollection::\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2cm]{class_g4_v_hits_collection}
\end{center}
\end{figure}
...
Definition at line 40 of file Geant4Classes.h.
