...
\subsubsection[{$\sim$TiXmlDocument}]{\setlength{\rightskip}{0pt plus 5cm}virtual TiXmlDocument::$\sim$TiXmlDocument ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
...
\subsubsection[{Accept}]{\setlength{\rightskip}{0pt plus 5cm}bool TiXmlDocument::Accept ({\bf TiXmlVisitor} $\ast$ {\em content}) const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\subsubsection[{Clone}]{\setlength{\rightskip}{0pt plus 5cm}{\bf TiXmlNode} $\ast$ TiXmlDocument::Clone () const\hspace{0.3cm}{\ttfamily  \mbox{[}protected, virtual\mbox{]}}}}
...
\subsubsection[{CopyTo}]{\setlength{\rightskip}{0pt plus 5cm}void TiXmlDocument::CopyTo ({\bf TiXmlDocument} $\ast$ {\em target}) const\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
...
Referenced by Clone(), operator=(), and TiXmlDocument().\hypertarget{class_ti_xml_document_a6dfc01a6e5d58e56acd537dfd3bdeb29}{
...
\subsubsection[{ErrorCol}]{\setlength{\rightskip}{0pt plus 5cm}int TiXmlDocument::ErrorCol () const\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{ErrorDesc}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$ TiXmlDocument::ErrorDesc () const\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
References errorLocation, and TiXmlCursor::row.\hypertarget{class_ti_xml_document_a41f6fe7200864d1dca663d230caf8db6}{
\index{TiXmlDocument@{TiXmlDocument}!LoadFile@{LoadFile}}
\index{LoadFile@{LoadFile}!TiXmlDocument@{TiXmlDocument}}
\subsubsection[{LoadFile}]{\setlength{\rightskip}{0pt plus 5cm}bool TiXmlDocument::LoadFile (FILE $\ast$ {\em file}, \/  {\bf TiXmlEncoding} {\em encoding} = {\ttfamily {\bf TIXML\_\-DEFAULT\_\-ENCODING}})}}
...
\index{TiXmlDocument@{TiXmlDocument}!LoadFile@{LoadFile}}
\index{LoadFile@{LoadFile}!TiXmlDocument@{TiXmlDocument}}
\subsubsection[{LoadFile}]{\setlength{\rightskip}{0pt plus 5cm}bool TiXmlDocument::LoadFile (const char $\ast$ {\em filename}, \/  {\bf TiXmlEncoding} {\em encoding} = {\ttfamily {\bf TIXML\_\-DEFAULT\_\-ENCODING}})}}
...
\index{TiXmlDocument@{TiXmlDocument}!LoadFile@{LoadFile}}
\index{LoadFile@{LoadFile}!TiXmlDocument@{TiXmlDocument}}
\subsubsection[{LoadFile}]{\setlength{\rightskip}{0pt plus 5cm}bool TiXmlDocument::LoadFile ({\bf TiXmlEncoding} {\em encoding} = {\ttfamily {\bf TIXML\_\-DEFAULT\_\-ENCODING}})}}
...
\subsubsection[{Parse}]{\setlength{\rightskip}{0pt plus 5cm}const char $\ast$ TiXmlDocument::Parse (const char $\ast$ {\em p}, \/  {\bf TiXmlParsingData} $\ast$ {\em data} = {\ttfamily 0}, \/  {\bf TiXmlEncoding} {\em encoding} = {\ttfamily {\bf TIXML\_\-DEFAULT\_\-ENCODING}})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\subsubsection[{RootElement}]{\setlength{\rightskip}{0pt plus 5cm}{\bf TiXmlElement}$\ast$ TiXmlDocument::RootElement ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_ti_xml_document_a0b43e762a23f938b06651bc90b8a1013}


Definition at line 1610 of file tinyxml.h.

References TiXmlNode::FirstChildElement().\hypertarget{class_ti_xml_document_ad09d17927f908f40efb406af2fb873be}{
\index{TiXmlDocument@{TiXmlDocument}!RootElement@{RootElement}}
\index{RootElement@{RootElement}!TiXmlDocument@{TiXmlDocument}}
...
References Print(), TIXML\_\-UTF\_\-LEAD\_\-0, TIXML\_\-UTF\_\-LEAD\_\-1, TIXML\_\-UTF\_\-LEAD\_\-2, and useMicrosoftBOM.\hypertarget{class_ti_xml_document_ae869f5ebf7fc54c4a1d737fb4689fd44}{
\index{TiXmlDocument@{TiXmlDocument}!SaveFile@{SaveFile}}
\index{SaveFile@{SaveFile}!TiXmlDocument@{TiXmlDocument}}
...
\subsubsection[{TabSize}]{\setlength{\rightskip}{0pt plus 5cm}int TiXmlDocument::TabSize () const\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{ToDocument}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf TiXmlDocument}$\ast$ TiXmlDocument::ToDocument ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
...
\index{TiXmlDocument@{TiXmlDocument}!ToDocument@{ToDocument}}
\index{ToDocument@{ToDocument}!TiXmlDocument@{TiXmlDocument}}
\subsubsection[{ToDocument}]{\setlength{\rightskip}{0pt plus 5cm}virtual const {\bf TiXmlDocument}$\ast$ TiXmlDocument::ToDocument () const\hspace{0.3cm}{\ttfamily  \mbox{[}inline, virtual\mbox{]}}}}
